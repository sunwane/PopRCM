  ...
  return (
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <button
          type="button"
          className="w-full bg-white lg:text-sm md:text-sm text-xs hover:bg-gray-100 text-gray-900 font-medium py-3 px-4 rounded-lg transition-colors flex items-center justify-center lg:gap-3 md:gap-3 gap-2"
        >
          <svg className="lg:w-5 lg:h-5 md:w-5 md:h-5 w-4 h-4" viewBox="0 0 24 24">
