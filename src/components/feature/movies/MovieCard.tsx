...
export default function MovieCard({ movie }: MovieCardProps) {
  return (
    <div className="lg:w-42 md:w-42 sm:w-32 w-32 text-white cursor-pointer hover:scale-105 transition-transform">
      {/* Image */}
      <div 
      ...
      <div className="text-center">
        ...
        <p className="lg:text-[13px] md:text-[13px] sm:text-[11px] text-[11px] text-gray-500">{movie.originalName}</p>
      </div>
    </div>
  );
}