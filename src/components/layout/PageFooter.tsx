export default function PageFooter() {
  return (
    <footer className="bg-gray-900 text-white py-6 mt-10 px-4">
      <div className="max-w-[60vw] px-4 lg:text-left md:text-center sm:text-center">

        <div className="py-2 flex lg:flex-row md:flex-col sm:flex-col lg:items-center md:items-center sm:items-center lg:justify-start md:justify-center sm:justify-center gap-10">
          <img
            src="/Logo.png"
            alt="PopRCM Logo"
            className="h-16 w-auto"
          />
          <div className="flex lg:flex-row md:flex-row sm:flex-row lg:items-center md:items-center sm:items-center lg:justify-start md:justify-center sm:justify-center gap-2.5">
        ...
        <div className="flex lg:flex-row md:flex-row sm:flex-row lg:items-center 
          md:items-center sm:items-center lg:justify-start md:justify-center sm:justify-center
          gap-10 mt-2">
          <a href="/#" className="text-white hover:text-(--hover)" >Chính sách bảo mật</a>
          <a href="/#" className="text-white hover:text-(--hover)">Điều khoản sử dụng</a>
          <a href="/#" className="text-white hover:text-(--hover)">Dự án học tập</a>
          <a href="/about" className="text-white hover:text-(--hover)">Về chúng tôi</a>
        </div>

        <div>
          <p className="lg:text-sm md:text-sm sm:text-[10px] text-gray-400 px-2 py-5 lg:text-justify md:text-center sm:text-center">
        ...
        <div className="lg:text-[16px] md:text-sm sm:text-xs">
